...
import { Stethoscope, Pill, Shield, Github, Linkedin, Home, Users, Brain, AlertCircle } from "lucide-react"
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white">
      {/* API Key Alert */}
      {!hasApiKey && (
        <div className="bg-blue-600 text-white py-2 px-4 text-center text-sm flex items-center justify-center gap-2">
          <AlertCircle className="h-4 w-4" />
          AI features are currently limited. 
          <Link href="/setup" className="underline font-bold ml-1">
